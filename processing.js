...
function predictImage() {
    ...
    // Calculating the bounding rectangle
    ...
    // Now shifting the image so that the center of mass is at the center of the image
    // shift is the difference between the modpoint and the center of mass
    ...
    // Used to get float values or else we will get only 0 and 1 after division
    ...
    result.print();
    // dataSync is used to get the array of predictions
    ...
    // Necessary deletion of objects to free up space
    image.delete();
    contours.delete();
    cnt.delete();
    hierarchy.delete();
